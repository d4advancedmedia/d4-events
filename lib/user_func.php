...
function d4events_render_single($style,$calendar_date,$files) {
	...
	elseif($style == 'list') {
		...
		$event_content .= '<h5 class="cal-event-title">'.$link_open.'<span>'.get_the_title().'</span>'.$link_close.'<span class="events_list-datetime"><span class="events_list-date">'.date('m/d/Y',$calendar_date).'</span><span class="events_list-time">'.$datetime_array['d4events_start_time'].'</span></span></h5>';
...
function d4events_process_events($event_date,$category,$events_query,$style,$range,$lastdate,$files) {
