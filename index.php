...
function d4events_admin_elements() {
    ...
    wp_register_script( 'd4events-admin', plugins_url( 'js/d4events-admin.js' , __FILE__ ), array( 'jquery' ), '3.1.1', true );
...
function register_d4events_elements() {
	wp_register_style( 'd4events', plugins_url( 'css/d4events.css' , __FILE__ ), '3.1.1' );
	...
	wp_register_script( 'd4events', plugins_url( 'js/d4events.js' , __FILE__ ), array( 'jquery' ), '3.1.1', true );
