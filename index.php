...
function d4events_admin_elements() {
    ...
    wp_register_script( 'd4events-admin', plugins_url( 'js/d4events-admin.js' , __FILE__ ), array( 'jquery' ), 'v3', true );
...
function register_d4events_elements() {
	...
	wp_register_script( 'd4events', plugins_url( 'js/d4events.js' , __FILE__ ), array( 'jquery' ), 'v3', true );
